...
const productRoutes = require('./routes/products')(pool, formatProductResponse);
const categoriesRoutes = require('./routes/categories');
const reservationsRoutes = require('./routes/reservations');
const adminRoutes = require('./routes/admin')(pool, authMiddleware, adminMiddleware, supabase, productBucketName, isProduction, formatProductResponse);
...
app.use('/api/orders', ordersRoutesInstance);
